...
from multitask_perception.modeling.layers.espnetv2_utils import BR
from multitask_perception.modeling.layers.espnetv2_utils import CBR
from multitask_perception.modeling.layers.espnetv2_utils import C
from multitask_perception.modeling.layers.espnetv2_utils import Shuffle
...
class EfficientPyrPool(nn.Module):
    ...
    def __init__(
        ...
        self.merge_layer = nn.Sequential(
            ...
            nn.Conv2d(
                proj_planes, out_planes, kernel_size=1, stride=1, bias=not last_layer_br
            ),
        )
        if last_layer_br:
